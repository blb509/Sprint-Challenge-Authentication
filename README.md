...
We can use sessions to keep data of a user saved across different requests so that they
dont always need to validate their credentials.

1. What does bcrypt do to help us store passwords in a secure manner.

dcrypt encodes our passwords so they are not saved in plain text on our database.

1. What does bcrypt do to slow down attackers?

they have to decrypt the password before they can see it
